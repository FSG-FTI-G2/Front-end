...
Command: npx gltfjsx@6.5.3 P:\FA24\Dev\Front-end\public\models\robot_playground.glb 
            ...
            <group name="Object_2">
              <group name="RootNode">
                <group name="holo" scale={1.877}>
                  <group name="group36" position={[0.33, 0, -0.099]} rotation={[-Math.PI, -0.142, -Math.PI]} scale={0.989}>
                    <group name="group39" rotation={[0, 0.877, 0]}>
                      <group name="group37" position={[-4.63, 14.294, 1.994]}>
                        <group name="group31" position={[4.63, -4.887, -1.994]} rotation={[0.006, 0, 0.01]} scale={1.182}>
                          ...
                          <group name="group35" position={[0.225, 0.107, 0.003]} rotation={[-Math.PI, -1.463, Math.PI]}>
                            <group name="group38" position={[0.039, 0.755, 0.248]}>
                              <group name="group29" position={[-0.027, -10.245, -0.036]} rotation={[0, Math.PI / 4, 0]}>
                                <group name="group21" position={[-12.687, 10.697, 0]} scale={0.245}>
                                  <group name="MASH1_ReproMesh12" position={[0, 0.239, 0]} rotation={[-1.132, 0, Math.PI / 2]} scale={[1.033, 1, 1.033]}>
                              ...
                              <group name="group28" position={[-0.027, -10.245, -0.036]} rotation={[0, Math.PI / 2, 0]}>
                                <group name="group21_1" position={[-12.687, 10.697, 0]} scale={0.245}>
                                  <group name="MASH1_ReproMesh12_1" position={[0, 0.239, 0]} rotation={[-1.132, 0, Math.PI / 2]} scale={[1.033, 1, 1.033]}>
                              ...
                              <group name="group27" position={[-0.027, -10.245, -0.036]} rotation={[-Math.PI, Math.PI / 4, Math.PI]}>
                                <group name="group20" position={[-12.687, 10.697, 0]} scale={0.245}>
                                  <group name="MASH1_ReproMesh11" position={[0, 0.239, 0]} rotation={[-1.132, 0, Math.PI / 2]} scale={[1.033, 1, 1.033]}>
                                  ...
                                  <group name="group13" rotation={[0, 1.132, 0]}>
                                    <group name="group6" position={[0, 0.028, 0]} rotation={[0.479, 0.1, -0.002]} scale={2.37}>
                                      <group name="pHelix1">
                              ...
                              <group name="group26" position={[-0.027, -10.245, -0.036]} rotation={[-Math.PI, 0, -Math.PI]}>
                                <group name="group19" position={[-12.687, 10.697, 0]} scale={0.245}>
                                  <group name="MASH1_ReproMesh10" position={[0, 0.239, 0]} rotation={[-1.132, 0, Math.PI / 2]} scale={[1.033, 1, 1.033]}>
                                  ...
                                  <group name="group12" rotation={[0, 1.132, 0]}>
                                    <group name="group4" position={[-0.254, 1.103, -0.402]} rotation={[-0.176, -0.673, 0.273]} scale={1.554}>
                              ...
                              <group name="group25" position={[-0.027, -10.245, -0.036]} rotation={[-Math.PI, -Math.PI / 4, -Math.PI]}>
                                <group name="group18" position={[-12.692, 10.697, 0]} scale={0.245}>
                                  <group name="MASH1_ReproMesh9" position={[0, 0.239, 0]} rotation={[-1.132, 0, Math.PI / 2]} scale={[1.033, 1, 1.033]}>
                              ...
                              <group name="group23" position={[-0.027, -10.245, -0.036]} rotation={[0, -Math.PI / 4, 0]}>
                                <group name="group16" position={[-12.687, 10.697, 0]} scale={0.245}>
                                  <group name="MASH1_ReproMesh7" position={[0, 0.239, 0]} rotation={[-1.132, 0, Math.PI / 2]} scale={[1.033, 1, 1.033]}>
                              ...
                              <group name="group22" position={[-0.027, -10.245, -0.036]}>
                                <group name="group15" position={[-12.687, 10.697, 0]} scale={0.245}>
                                  <group name="MASH1_ReproMesh6" position={[0, 0.239, 0]} rotation={[-1.132, 0, Math.PI / 2]} scale={[1.033, 1, 1.033]}>
                                  ...
                                  <group name="group8" rotation={[0, 1.132, 0]}>
                                    <group name="group1" rotation={[-0.513, 0, 0]} scale={[1.223, 0.98, 1.223]}>
                              ...
                              <group name="pCylinder4" position={[-0.027, 0.458, -0.036]} scale={[0.818, 0.439, 0.818]}>
                                <mesh name="pCylinder4_holo1_0" geometry={nodes.pCylinder4_holo1_0.geometry} material={materials.holo1} />
                              </group>
                            </group>
                            <group name="group24" position={[0.021, -10.723, 0.224]} rotation={[0, -Math.PI / 2, 0]}>
                              <group name="group17" position={[-12.356, 11.797, 0.231]} scale={0.295}>
                                ...
                                <group name="MASH1_ReproMesh8" position={[0.227, 0.006, -0.549]} rotation={[-1.132, 0, Math.PI / 2]} scale={[0.818, 0.792, 0.818]}>
                ...
                <group name="bot_geo">
                  ...
                  <group name="neckBase" />
                  <group name="face">
                    <group name="eyeCloseKawaii" position={[-13.612, -3.321, -2.904]} scale={1.29} />
                    ...
                    <group name="group34" rotation={[-Math.PI, 0, 0]} scale={-1}>
                      <group name="eyeCloseKawaii1" position={[-13.612, -3.321, -2.904]} scale={1.29} />
                      <group name="eye1" position={[-5.679, -4.257, -1.92]} rotation={[-Math.PI, 0, 0]} scale={-1.155} />
                  ...
                  <group name="Main">
                    <group name="DeformationSystem">
                      <group name="Object_159">
                        ...
                        <group name="Object_203" position={[-13.612, -3.321, -2.904]} scale={1.29} />
                        <group name="Object_205" position={[0.412, -4.257, -1.92]} scale={1.155} />
                        <group name="Object_207" position={[-13.482, -3.211, -2.249]} scale={1.155} />
                        ...
                        <group name="Object_219" position={[13.612, -3.321, -2.904]} scale={[-1.29, 1.29, 1.29]} />
                        <group name="Object_221" position={[5.679, -4.257, -1.92]} scale={1.155} />
                        <group name="Object_223" position={[13.482, -3.211, -2.249]} scale={[-1.155, 1.155, 1.155]} />
                        <group name="Object_225" position={[15.998, 1.374, -1.498]} scale={[-1, 1, 1]} />
